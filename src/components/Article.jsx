...
function Article() {
  ...
  return (
    <div className='flex flex-col w-full gap-2 border-[#E0E0E0] lg:border-[1px] md:border-[1px] rounded-[4px] mt-5 lg:h-[472px] h-auto justify-between relative '>
      {/* Image */}
      <div className='h-[45%] justify-self-start'>
        <img src={background} alt="Background" className='h-48 w-full object-cover' />
      </div>

      {/* Type */}
      <div className='px-4'>
        <span className='text-[18px] font-medium'>✍️ Article</span>
      </div>
